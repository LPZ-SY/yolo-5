...
WELCOME_SENTENCE = "欢迎使用基于yolov11的摔倒检测系统"   # 欢迎的句子
...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.model_path = "runs/yolo11s_pretrained/train/weights/best.pt"  # todo 指明模型加载的位置的设备
    ...
    def initUI(self):
       ...
       # label_super.setText("<a href='https://blog.csdn.net/ECHOSON'>作者：吕佩哲</a>")
